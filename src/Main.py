...
grenades_fx = pygame.mixer.Sound('audio/grenade.wav')
grenades_fx.set_volume(0.5)
...
ammo_box_img = pygame.image.load('assets/icons/ammo_box.png').convert_alpha()
grenade_box_img = pygame.image.load('assets/icons/grenade_box.png').convert_alpha()
item_boxes = {
...
with open(f'docs/level{level}_data.csv', newline='') as csvfile:
